  ...
  if (!active) {
    return (
      ...
      >
        ...
        <span className="relative flex h-16 w-16 items-center justify-center rounded-full bg-gold text-background shadow-lg transition-transform group-hover:scale-110">
